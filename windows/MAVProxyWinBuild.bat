...
python.exe -m pip install -U wheel setuptools pip --user
python.exe -m pip install pywin32 lxml pymavlink numpy matplotlib pyserial opencv-python PyYAML Pygame Pillow wxpython prompt-toolkit scipy --user
python.exe -m pip install -U openai wave pyaudio --user
python.exe -m pip install -U pyinstaller==6.7.0 packaging --user
python.exe -m pip install -U requests --user
